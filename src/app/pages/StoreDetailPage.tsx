    ...
    <div className="min-h-screen bg-white pb-24">
        ...
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-1">
            <Link to="/cart" className="p-1 relative">
              ...
              {totalCount > 0 && <span className="absolute -top-1 -right-1 bg-[#0EA5E9] text-white text-[10px] min-w-[16px] h-4 rounded-full flex items-center justify-center px-1">{totalCount}</span>}
            </Link>
      ...
      <div className="px-4 py-4 border-b border-gray-100">
        <div className="flex items-center gap-2 mb-1">
          ...
          {store.badge && <span className="text-[10px] bg-gray-100 text-gray-600 px-2 py-0.5 rounded">{store.badge}</span>}
            ...
            <div className="px-4 pb-4 space-y-3">
              {store.specials.map((item) => (
                <div key={item.id} className="flex gap-3 items-center">
                  ...
                  <button onClick={() => handleAddToCart(item)} className="w-8 h-8 rounded-lg bg-gray-900 text-white flex items-center justify-center active:bg-gray-800">
